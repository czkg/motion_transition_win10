...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--model', type=str, default='', help='chooses which model to use. bicycle,, ...')
        ...
        parser.add_argument('--force_size', type=int, default=66, help='size of force, 22*3')
        parser.add_argument('--quat_size', type=int, default=88, help='size of quaternion, 22*4')

        parser.add_argument('--dropout', type=float, default=0.1, help='dropout for TFT network')
        parser.add_argument('--attn_dropout', type=float, default=0.0, help='attention dropout for TFT network')
        parser.add_argument('--n_head', type=int, default=4, help='number of heads for multi-head attention')
        ...
        parser.add_argument('--lafan_window', type=int, default=11, help='length of sequence')
        parser.add_argument('--lafan_offset', type=int, default=1, help='offset to sample the data')
        parser.add_argument('--lafan_samplerate', type=int, default=1, help='sample rate')
        parser.add_argument('--lafan_mode', type=str, default='seq', help='choose pose or sequence')
